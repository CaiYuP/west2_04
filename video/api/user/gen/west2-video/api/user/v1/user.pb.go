...
type UploadAvatarRequest struct {
	...
	Data          []byte `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"` // 头像原始数据（multipart/form-data 对应）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_user_user_proto_rawDesc = "" +
	"\n" +
	"\x13api/user/user.proto\x12\vapi.user.v1\x1a\x15api/common/base.proto\"\xe5\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"created_at\x18\a \x01(\v2\x18.api.common.v1.TimestampR\tcreatedAt\"_\n" +
	...
	"\n" +
	"avatar_url\x18\x02 \x01(\tR\tavatarUrl\"\x15\n" +
	"\x13GetMfaQrcodeRequest\"{\n" +
	"\x11GetMfaQrcodeReply\x12/\n" +
	"\x04base\x18\x01 \x01(\v2\x1b.api.common.v1.BaseResponseR\x04base\x12\x1d\n" +
	"\n" +
	"qrcode_url\x18\x02 \x01(\tR\tqrcodeUrl\x12\x16\n" +
	...
	"\x04page\x18\x03 \x01(\v2\x1b.api.common.v1.PageResponseR\x04page2\x95\x04\n" +
	"\vUserService\x12D\n" +
	"\bRegister\x12\x1c.api.user.v1.RegisterRequest\x1a\x1a.api.user.v1.RegisterReply\x12;\n" +
	"\x05Login\x12\x19.api.user.v1.LoginRequest\x1a\x17.api.user.v1.LoginReply\x12G\n" +
